...
class SeatMatrixData(models.Model):
    ...
    bond_penalty = models.CharField(null=True, blank=True)
    beds = models.CharField(max_length=50)
    cr_2023_1 = models.CharField(max_length=50, null=True, blank=True)
    cr_2023_2 = models.CharField(max_length=50, null=True, blank=True)
    cr_2023_3 = models.CharField(max_length=50, null=True, blank=True)
    cr_2023_4 = models.CharField(max_length=50, null=True, blank=True)
    cr_2023_5 = models.CharField(max_length=50, null=True, blank=True)
    cr_2024_1 = models.CharField(max_length=50, null=True, blank=True)
    cr_2024_2 = models.CharField(max_length=50, null=True, blank=True)
    cr_2024_3 = models.CharField(max_length=50, null=True, blank=True)
